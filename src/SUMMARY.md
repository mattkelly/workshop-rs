...
- [Common Programming Concepts](./common_concepts/title.md)
    ...
    - [Functions](./common_concepts/functions/title.md)
        - [Parameters](./common_concepts/functions/parameters.md)
        - [Definitions](./common_concepts/functions/definitions.md)
        - [Expressions 1](./common_concepts/functions/expressions_1.md)
        - [Expressions 2](./common_concepts/functions/expressions_2.md)
    ...
    - [Control Flow](./common_concepts/control_flow/title.md)
        - [If and Else](./common_concepts/control_flow/if_and_else.md)
        - [If in a Let Statement 1](./common_concepts/control_flow/if_in_a_let_statement_1.md)
        - [If in a Let Statement 2](./common_concepts/control_flow/if_in_a_let_statement_2.md)
        - [Loops 1](./common_concepts/control_flow/loops_1.md)
        - [Loops 2](./common_concepts/control_flow/loops_2.md)
        - [While Loops](./common_concepts/control_flow/while_loops.md)
        - [For Loops 1](./common_concepts/control_flow/for_loops_1.md)
        - [For Loops 2](./common_concepts/control_flow/for_loops_2.md)
...
- [Ownership](./ownership/title.md)
    ...
    - [&str and String](./ownership/str_and_string.md)
    - [A Heap Allocated String](./ownership/a_heap_allocated_string.md)
    - [RAII](./ownership/raii.md)
    - [Ways Variable and Data Interact](./ownership/interactions/title.md)
        - [Ways Variable and Data Interact: Move 1](./ownership/interactions/move_1.md)
        - [Ways Variable and Data Interact: Move 2](./ownership/interactions/move_2.md)
        - [Ways Variable and Data Interact: Move 3](./ownership/interactions/move_3.md)
        - [Ways Variable and Data Interact: Move 4](./ownership/interactions/move_4.md)
        - [Ways Variable and Data Interact: Move 5](./ownership/interactions/move_5.md)
        - [Ways Variable and Data Interact: Move 6](./ownership/interactions/move_6.md)
        - [Ways Variable and Data Interact: Move 7](./ownership/interactions/move_7.md)
        - [Ways Variable and Data Interact: Move 8](./ownership/interactions/move_8.md)
        - [Ways Variable and Data Interact: Clone](./ownership/interactions/clone.md)
    - [Stack-Only Data: Copy](./ownership/copy.md)
    - [Other Copy Types](./ownership/other_copy_types.md)
    - [Ownership and Functions](./ownership/ownership_and_functions.md)
    ...
    - [Mutable References 1](./ownership/mutable_references_1.md)
    ...
    - [Rules of References](./ownership/rules_of_references.md)
    - [Slices](./ownership/slices/title.md)
        - [String Slices 1](./ownership/slices/string_slices_1.md)
        - [String Slices 2](./ownership/slices/string_slices_2.md)
        - [String Literal Slices](./ownership/slices/string_literal_slices.md)
        - [Other Slices](./ownership/slices/other_slices.md)
    - [Recap](./ownership/recap.md)
...
- [Structs, Enums and Crates](./structs_enums_crates/title.md)
    ...
    - [Structs](./structs_enums_crates/structs/title.md)
        - [Declaration](./structs_enums_crates/structs/declaration.md)
        - [Instantiation](./structs_enums_crates/structs/instantiation.md)
        - [Modification](./structs_enums_crates/structs/modification.md)
        - [Constructor Short Hand](./structs_enums_crates/structs/constructor_short_hand.md)
        - [Update Syntax](./structs_enums_crates/structs/update_syntax.md)
        - [Tuple Structs](./structs_enums_crates/structs/tuple_structs.md)
        - [Unit Structs](./structs_enums_crates/structs/unit_structs.md)
        - [Ownership 1](./structs_enums_crates/structs/ownership_1.md)
        - [Ownership 2](./structs_enums_crates/structs/ownership_2.md)
        - [Adding Meaning](./structs_enums_crates/structs/adding_meaning.md)
        - [Adding Functionality with Derived Traits 1](./structs_enums_crates/structs/adding_functionality_with_derived_traits_1.md)
        - [Adding Functionality with Derived Traits 2](./structs_enums_crates/structs/adding_functionality_with_derived_traits_2.md)
        - [Adding Functionality with Derived Traits 3](./structs_enums_crates/structs/adding_functionality_with_derived_traits_3.md)
        - [Defining Methods](./structs_enums_crates/structs/defining_methods.md)
        - [Where did -> go? 1](./structs_enums_crates/structs/where_did_the_arrow_operator_go_1.md)
        - [Where did -> go? 2](./structs_enums_crates/structs/where_did_the_arrow_operator_go_2.md)
        - [Methods With More Parameters](./structs_enums_crates/structs/methods_with_more_parameters.md)
        - [Associated Functions](./structs_enums_crates/structs/assocated_functions.md)
        - [Multiple impl Blocks](./structs_enums_crates/structs/multiple_impl_blocks.md)
        - [Recap](./structs_enums_crates/structs/recap.md)
...
- [Closures](./closures/title.md)
    ...
    - [Type Inference and Annotation](./closures/inference_and_annotation.md)
